...
{
    [Region(Title = "Indroduction")] public AboutRegion Introduction { get; set; }

    [Region(Title = "First Content")] public AboutRegion FirstContent { get; set; }

    [Region(Title = "Second Content")] public AboutRegion SecondContent { get; set; }
